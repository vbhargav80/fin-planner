...
// NEW
export const CONTRIBUTION_CHANGE_AGE = { MIN: 40, MAX: 65, STEP: 1 };

export const DRAWDOWN_AMOUNT = { MIN: 40000, MAX: 150000, STEP: 1000 };
export const DRAWDOWN_RETURN = { MIN: 3, MAX: 9, STEP: 0.1 };
export const LIFESTYLE_AMOUNTS = { modest: 55000, comfortable: 80000, luxury: 100000 };